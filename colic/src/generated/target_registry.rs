...
pub const PORTABLE_V1: TargetProfileSpec = TargetProfileSpec {
    ...
    kernel_abi: 0,
    target_class: 0x00000000,
    compiler_emission_supported: true,
    operating_system: "portable",
    architecture: "portable",
    backend: "portable",
    record_alignment: 4096,
    io_granularity: 4096,
    resident_alignment: 16,
    allowed_layouts: PORTABLE_V1_ALLOWED_LAYOUTS,
};
...
pub const MACOS_ARM64_METAL_APPLE8_V1: TargetProfileSpec = TargetProfileSpec {
    ...
    allowed_layouts: MACOS_ARM64_METAL_APPLE8_V1_ALLOWED_LAYOUTS,
};
...
pub const LINUX_X86_64_AVX2_V1: TargetProfileSpec = TargetProfileSpec {
    ...
    io_granularity: 4096,
    resident_alignment: 16,
    allowed_layouts: LINUX_X86_64_AVX2_V1_ALLOWED_LAYOUTS,
};
