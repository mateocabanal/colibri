...
# Buffered and streamed tooling helpers must use the same v1.1 envelope minor.
p = Path("colic/src/target/mod.rs")
t = p.read_text().replace("put_u16(&mut payload, 10, 0);", "put_u16(&mut payload, 10, 1);")
p.write_text(t)
...
t = t.replace('                "U8" | "F8_E4M3FN" | "F8_E8M0" => 1,', '                "U8" | "I8" | "F8_E4M3FN" | "F8_E8M0" => 1,', 1)
p.write_text(t)
