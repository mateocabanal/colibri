...
cmp "$work/model-a.coli/manifest.coli" "$work/model-b.coli/manifest.coli"
cmp "$work/model-a.coli/data-00000.coli" "$work/model-b.coli/data-00000.coli"
